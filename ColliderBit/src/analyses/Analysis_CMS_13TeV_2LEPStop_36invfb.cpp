    ...
    public:
        ...
        void collect_results() {
           ...
           //  cout << "------------------------------------------------------------------------------------------------------------------------------ "<<endl;
            ...
            results_SRSF0.n_obs = 112.;
            results_SRSF0.n_bkg = 131.;
            results_SRSF0.n_bkg_err = 30.;
            results_SRSF0.n_sig_MC_sys = 0.;
            results_SRSF0.n_sig_MC = _SRSF[0];
            add_result(results_SRSF0);

            SignalRegionData results_SRSF1;
            results_SRSF1.sr_label = "SRSF1";
            results_SRSF1.n_obs = 7.;
            results_SRSF1.n_bkg = 4.1;
            results_SRSF1.n_bkg_err = 1.1;
            results_SRSF1.n_sig_MC_sys = 0.;
            results_SRSF1.n_sig_MC = _SRSF[1];
            add_result(results_SRSF1);

            SignalRegionData results_SRSF2;
            results_SRSF2.sr_label = "SRSF2";
            results_SRSF2.n_obs = 69.;
            results_SRSF2.n_bkg = 60.;
            results_SRSF2.n_bkg_err = 13.;
            results_SRSF2.n_sig_MC_sys = 0.;
            results_SRSF2.n_sig_MC = _SRSF[2];
            add_result(results_SRSF2);

            SignalRegionData results_SRSF3;
            results_SRSF3.sr_label = "SRSF3";
            results_SRSF3.n_obs = 1.;
            results_SRSF3.n_bkg = 4.8;
            results_SRSF3.n_bkg_err = 1.2;
            results_SRSF3.n_sig_MC_sys = 0.;
            results_SRSF3.n_sig_MC = _SRSF[3];
            add_result(results_SRSF3);

            SignalRegionData results_SRSF4;
            results_SRSF4.sr_label = "SRSF4";
            results_SRSF4.n_obs = 0.;
            results_SRSF4.n_bkg = 0.5;
            results_SRSF4.n_bkg_err = 0.2;
            results_SRSF4.n_sig_MC_sys = 0.;
            results_SRSF4.n_sig_MC = _SRSF[4];
            add_result(results_SRSF4);

            SignalRegionData results_SRSF5;
            results_SRSF5.sr_label = "SRSF5";
            results_SRSF5.n_obs = 2.;
            results_SRSF5.n_bkg = 1.9;
            results_SRSF5.n_bkg_err = 0.5;
            results_SRSF5.n_sig_MC_sys = 0.;
            results_SRSF5.n_sig_MC = _SRSF[5];
            add_result(results_SRSF5);

            SignalRegionData results_SRSF6;
            results_SRSF6.sr_label = "SRSF6";
            results_SRSF6.n_obs = 2.;
            results_SRSF6.n_bkg = 1.1;
            results_SRSF6.n_bkg_err = 0.6;
            results_SRSF6.n_sig_MC_sys = 0.;
            results_SRSF6.n_sig_MC = _SRSF[6];
            add_result(results_SRSF6);

            SignalRegionData results_SRSF7;
            results_SRSF7.sr_label = "SRSF7";
            results_SRSF7.n_obs = 2.;
            results_SRSF7.n_bkg = 0.6;
            results_SRSF7.n_bkg_err = 0.3;
            results_SRSF7.n_sig_MC_sys = 0.;
            results_SRSF7.n_sig_MC = _SRSF[7];
            add_result(results_SRSF7);

            SignalRegionData results_SRSF8;
            results_SRSF8.sr_label = "SRSF8";
            results_SRSF8.n_obs = 1.;
            results_SRSF8.n_bkg = 2.1;
            results_SRSF8.n_bkg_err = 0.7;
            results_SRSF8.n_sig_MC_sys = 0.;
            results_SRSF8.n_sig_MC = _SRSF[8];
            add_result(results_SRSF8);

            SignalRegionData results_SRSF9;
            results_SRSF9.sr_label = "SRSF9";
            results_SRSF9.n_obs = 1.;
            results_SRSF9.n_bkg = 1.6;
            results_SRSF9.n_bkg_err = 0.4;
            results_SRSF9.n_sig_MC_sys = 0.;
            results_SRSF9.n_sig_MC = _SRSF[9];
            add_result(results_SRSF9);

            SignalRegionData results_SRSF10;
            results_SRSF10.sr_label = "SRSF10";
            results_SRSF10.n_obs = 0.;
            results_SRSF10.n_bkg = 0.3;
            results_SRSF10.n_bkg_err = 0.1;
            results_SRSF10.n_sig_MC_sys = 0.;
            results_SRSF10.n_sig_MC = _SRSF[10];
            add_result(results_SRSF10);

            SignalRegionData results_SRSF11;
            results_SRSF11.sr_label = "SRSF11";
            results_SRSF11.n_obs = 2.;
            results_SRSF11.n_bkg = 1.7;
            results_SRSF11.n_bkg_err = 0.4;
            results_SRSF11.n_sig_MC_sys = 0.;
            results_SRSF11.n_sig_MC = _SRSF[11];
            add_result(results_SRSF11);

            SignalRegionData results_SRSF12;
            results_SRSF12.sr_label = "SRSF12";
            results_SRSF12.n_obs = 1.;
            results_SRSF12.n_bkg = 0.7;
            results_SRSF12.n_bkg_err = 0.3;
            results_SRSF12.n_sig_MC_sys = 0.;
            results_SRSF12.n_sig_MC = _SRSF[12];
            add_result(results_SRSF12);

            // Different falvor
            SignalRegionData results_SRDF0;
            results_SRDF0.sr_label = "SRDF0";
            results_SRDF0.n_obs = 141.;
            results_SRDF0.n_bkg = 139.;
            results_SRDF0.n_bkg_err = 32.;
            results_SRDF0.n_sig_MC_sys = 0.;
            results_SRDF0.n_sig_MC = _SRDF[0];
            add_result(results_SRDF0);

            SignalRegionData results_SRDF1;
            results_SRDF1.sr_label = "SRDF1";
            results_SRDF1.n_obs = 6.;
            results_SRDF1.n_bkg = 4.0;
            results_SRDF1.n_bkg_err = 1.1;
            results_SRDF1.n_sig_MC_sys = 0.;
            results_SRDF1.n_sig_MC = _SRDF[1];
            add_result(results_SRDF1);

            SignalRegionData results_SRDF2;
            results_SRDF2.sr_label = "SRDF2";
            results_SRDF2.n_obs = 67.;
            results_SRDF2.n_bkg = 70.;
            results_SRDF2.n_bkg_err = 17.;
            results_SRDF2.n_sig_MC_sys = 0.;
            results_SRDF2.n_sig_MC = _SRDF[2];
            add_result(results_SRDF2);

            SignalRegionData results_SRDF3;
            results_SRDF3.sr_label = "SRDF3";
            results_SRDF3.n_obs = 5.;
            results_SRDF3.n_bkg = 3.9;
            results_SRDF3.n_bkg_err = 1.0;
            results_SRDF3.n_sig_MC_sys = 0.;
            results_SRDF3.n_sig_MC = _SRDF[3];
            add_result(results_SRDF3);

            SignalRegionData results_SRDF4;
            results_SRDF4.sr_label = "SRDF4";
            results_SRDF4.n_obs = 1.;
            results_SRDF4.n_bkg = 0.7;
            results_SRDF4.n_bkg_err = 0.2;
            results_SRDF4.n_sig_MC_sys = 0.;
            results_SRDF4.n_sig_MC = _SRDF[4];
            add_result(results_SRDF4);

            SignalRegionData results_SRDF5;
            results_SRDF5.sr_label = "SRDF5";
            results_SRDF5.n_obs = 1.;
            results_SRDF5.n_bkg = 2.1;
            results_SRDF5.n_bkg_err = 0.5;
            results_SRDF5.n_sig_MC_sys = 0.;
            results_SRDF5.n_sig_MC = _SRDF[5];
            add_result(results_SRDF5);

            SignalRegionData results_SRDF6;
            results_SRDF6.sr_label = "SRDF6";
            results_SRDF6.n_obs = 1.;
            results_SRDF6.n_bkg = 0.5;
            results_SRDF6.n_bkg_err = 0.2;
            results_SRDF6.n_sig_MC_sys = 0.;
            results_SRDF6.n_sig_MC = _SRDF[6];
            add_result(results_SRDF6);

            SignalRegionData results_SRDF7;
            results_SRDF7.sr_label = "SRDF7";
            results_SRDF7.n_obs = 0.;
            results_SRDF7.n_bkg = 0.3;
            results_SRDF7.n_bkg_err = 0.2;
            results_SRDF7.n_sig_MC_sys = 0.;
            results_SRDF7.n_sig_MC = _SRDF[7];
            add_result(results_SRDF7);

            SignalRegionData results_SRDF8;
            results_SRDF8.sr_label = "SRDF8";
            results_SRDF8.n_obs = 1.;
            results_SRDF8.n_bkg = 0.8;
            results_SRDF8.n_bkg_err = 0.2;
            results_SRDF8.n_sig_MC_sys = 0.;
            results_SRDF8.n_sig_MC = _SRDF[8];
            add_result(results_SRDF8);

            SignalRegionData results_SRDF9;
            results_SRDF9.sr_label = "SRDF9";
            results_SRDF9.n_obs = 0.;
            results_SRDF9.n_bkg = 0.9;
            results_SRDF9.n_bkg_err = 0.3;
            results_SRDF9.n_sig_MC_sys = 0.;
            results_SRDF9.n_sig_MC = _SRDF[9];
            add_result(results_SRDF9);

            SignalRegionData results_SRDF10;
            results_SRDF10.sr_label = "SRDF10";
            results_SRDF10.n_obs = 0.;
            results_SRDF10.n_bkg = 0.1;
            results_SRDF10.n_bkg_err = 0.1;
            results_SRDF10.n_sig_MC_sys = 0.;
            results_SRDF10.n_sig_MC = _SRDF[10];
            add_result(results_SRDF10);

            SignalRegionData results_SRDF11;
            results_SRDF11.sr_label = "SRDF11";
            results_SRDF11.n_obs = 1.;
            results_SRDF11.n_bkg = 1.2;
            results_SRDF11.n_bkg_err = 0.3;
            results_SRDF11.n_sig_MC_sys = 0.;
            results_SRDF11.n_sig_MC = _SRDF[11];
            add_result(results_SRDF11);

            SignalRegionData results_SRDF12;
            results_SRDF12.sr_label = "SRDF12";
            results_SRDF12.n_obs = 0.;
            results_SRDF12.n_bkg = 0.5;
            results_SRDF12.n_bkg_err = 0.2;
            results_SRDF12.n_sig_MC_sys = 0.;
            results_SRDF12.n_sig_MC = _SRDF[12];
            add_result(results_SRDF12);

            // DF+SF
            SignalRegionData results_SRALL0;
            results_SRALL0.sr_label = "SRALL0";
            results_SRALL0.n_obs = 253.;
            results_SRALL0.n_bkg = 271.;
            results_SRALL0.n_bkg_err = 61.;
            results_SRALL0.n_sig_MC_sys = 0.;
            results_SRALL0.n_sig_MC = _SRALL[0];
            add_result(results_SRALL0);

            SignalRegionData results_SRALL1;
            results_SRALL1.sr_label = "SRALL1";
            results_SRALL1.n_obs = 13.;
            results_SRALL1.n_bkg = 8.1;
            results_SRALL1.n_bkg_err = 2.0;
            results_SRALL1.n_sig_MC_sys = 0.;
            results_SRALL1.n_sig_MC = _SRALL[1];
            add_result(results_SRALL1);

            SignalRegionData results_SRALL2;
            results_SRALL2.sr_label = "SRALL2";
            results_SRALL2.n_obs = 136.;
            results_SRALL2.n_bkg = 130.;
            results_SRALL2.n_bkg_err = 29.;
            results_SRALL2.n_sig_MC_sys = 0.;
            results_SRALL2.n_sig_MC = _SRALL[2];
            add_result(results_SRALL2);

            SignalRegionData results_SRALL3;
            results_SRALL3.sr_label = "SRALL3";
            results_SRALL3.n_obs = 6.;
            results_SRALL3.n_bkg = 8.7;
            results_SRALL3.n_bkg_err = 2.0;
            results_SRALL3.n_sig_MC_sys = 0.;
            results_SRALL3.n_sig_MC = _SRALL[3];
            add_result(results_SRALL3);

            SignalRegionData results_SRALL4;
            results_SRALL4.sr_label = "SRALL4";
            results_SRALL4.n_obs = 1.;
            results_SRALL4.n_bkg = 1.2;
            results_SRALL4.n_bkg_err = 0.4;
            results_SRALL4.n_sig_MC_sys = 0.;
            results_SRALL4.n_sig_MC = _SRALL[4];
            add_result(results_SRALL4);

            SignalRegionData results_SRALL5;
            results_SRALL5.sr_label = "SRALL5";
            results_SRALL5.n_obs = 3.;
            results_SRALL5.n_bkg = 4.0;
            results_SRALL5.n_bkg_err = 0.8;
            results_SRALL5.n_sig_MC_sys = 0.;
            results_SRALL5.n_sig_MC = _SRALL[5];
            add_result(results_SRALL5);

            SignalRegionData results_SRALL6;
            results_SRALL6.sr_label = "SRALL6";
            results_SRALL6.n_obs = 3.;
            results_SRALL6.n_bkg = 1.5;
            results_SRALL6.n_bkg_err = 0.7;
            results_SRALL6.n_sig_MC_sys = 0.;
            results_SRALL6.n_sig_MC = _SRALL[6];
            add_result(results_SRALL6);

            SignalRegionData results_SRALL7;
            results_SRALL7.sr_label = "SRALL7";
            results_SRALL7.n_obs = 2.;
            results_SRALL7.n_bkg = 0.8;
            results_SRALL7.n_bkg_err = 0.3;
            results_SRALL7.n_sig_MC_sys = 0.;
            results_SRALL7.n_sig_MC = _SRALL[7];
            add_result(results_SRALL7);

            SignalRegionData results_SRALL8;
            results_SRALL8.sr_label = "SRALL8";
            results_SRALL8.n_obs = 2.;
            results_SRALL8.n_bkg = 2.9;
            results_SRALL8.n_bkg_err = 0.7;
            results_SRALL8.n_sig_MC_sys = 0.;
            results_SRALL8.n_sig_MC = _SRALL[8];
            add_result(results_SRALL8);

            SignalRegionData results_SRALL9;
            results_SRALL9.sr_label = "SRALL9";
            results_SRALL9.n_obs = 1.;
            results_SRALL9.n_bkg = 2.5;
            results_SRALL9.n_bkg_err = 0.5;
            results_SRALL9.n_sig_MC_sys = 0.;
            results_SRALL9.n_sig_MC = _SRALL[9];
            add_result(results_SRALL9);

            SignalRegionData results_SRALL10;
            results_SRALL10.sr_label = "SRALL10";
            results_SRALL10.n_obs = 0.;
            results_SRALL10.n_bkg = 0.4;
            results_SRALL10.n_bkg_err = 0.2;
            results_SRALL10.n_sig_MC_sys = 0.;
            results_SRALL10.n_sig_MC = _SRALL[10];
            add_result(results_SRALL10);

            SignalRegionData results_SRALL11;
            results_SRALL11.sr_label = "SRALL11";
            results_SRALL11.n_obs = 3.;
            results_SRALL11.n_bkg = 2.9;
            results_SRALL11.n_bkg_err = 0.6;
            results_SRALL11.n_sig_MC_sys = 0.;
            results_SRALL11.n_sig_MC = _SRALL[11];
            add_result(results_SRALL11);

            SignalRegionData results_SRALL12;
            results_SRALL12.sr_label = "SRALL12";
            results_SRALL12.n_obs = 1.;
            results_SRALL12.n_bkg = 1.1;
            results_SRALL12.n_bkg_err = 0.4;
            results_SRALL12.n_sig_MC_sys = 0.;
            results_SRALL12.n_sig_MC = _SRALL[12];
            add_result(results_SRALL12);*/

            /*//Signal region A
            SignalRegionData results_SRA0;
            results_SRA0.sr_label = "SRA0";
            results_SRA0.n_obs = 22.;
            results_SRA0.n_bkg = 20.8;
            results_SRA0.n_bkg_err = 4.4;
            results_SRA0.n_sig_MC_sys = 0.;
            results_SRA0.n_sig_MC = _SRA[0];
            add_result(results_SRA0);

            SignalRegionData results_SRA1;
            results_SRA1.sr_label = "SRA1";
            results_SRA1.n_obs = 6.;
            results_SRA1.n_bkg = 6.2;
            results_SRA1.n_bkg_err = 1.0;
            results_SRA1.n_sig_MC_sys = 0.;
            results_SRA1.n_sig_MC = _SRA[1];
            add_result(results_SRA1);

            SignalRegionData results_SRA2;
            results_SRA2.sr_label = "SRA2";
            results_SRA2.n_obs = 1.;
            results_SRA2.n_bkg = 1.1;
            results_SRA2.n_bkg_err = 0.4;
            results_SRA2.n_sig_MC_sys = 0.;
            results_SRA2.n_sig_MC = _SRA[2];
