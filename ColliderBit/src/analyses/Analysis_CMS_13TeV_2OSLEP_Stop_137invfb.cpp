...
namespace Gambit {
  namespace ColliderBit {
    ...
    class Analysis_CMS_13TeV_2OSLEP_Stop_137invfb : public Analysis {
    private:
    ...
    public:
        ...
        Analysis_CMS_13TeV_2OSLEP_Stop_137invfb() {

            set_analysis_name("CMS_13TeV_2OSLEP_Stop_137invfb");
            set_luminosity(137);
        ...
        {
            const Analysis_CMS_13TeV_2OSLEP_Stop_137invfb* specificOther
                = dynamic_cast<const Analysis_CMS_13TeV_2OSLEP_Stop_137invfb*>(other);
    ...
    DEFINE_ANALYSIS_FACTORY(CMS_13TeV_2OSLEP_Stop_137invfb)
