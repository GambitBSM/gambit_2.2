    ...
    public:
      ...
      void collect_results() {
       ...
       // cutflowFile.close();
        ...
        // results_SR1.n_obs = 793.;
        // results_SR1.n_bkg = 793.;
        // results_SR1.n_bkg_err = 32.2;
        // results_SR1.n_sig_MC_sys = 0.;
        // results_SR1.n_sig_MC = _numSR1;
        // add_result(results_SR1);

        // SignalRegionData results_SR2;
        // results_SR2.sr_label = "SR2";
        // results_SR2.n_obs = 57.;
        // results_SR2.n_bkg = 54.9;
        // results_SR2.n_bkg_err = 7.;
        // results_SR2.n_sig_MC_sys = 0.;
        // results_SR2.n_sig_MC = _numSR2;
        // add_result(results_SR2);

        // SignalRegionData results_SR3;
        // results_SR3.sr_label = "SR3";
        // results_SR3.n_obs = 29.;
        // results_SR3.n_bkg = 21.6;
        // results_SR3.n_bkg_err = 5.6;
        // results_SR3.n_sig_MC_sys = 0.;
        // results_SR3.n_sig_MC = _numSR3;
        ...
        // results_SR4.n_obs = 2.;
        // results_SR4.n_bkg = 6.;
        // results_SR4.n_bkg_err = 1.9;
        // results_SR4.n_sig_MC_sys = 0.;
        // results_SR4.n_sig_MC = _numSR4;
        // add_result(results_SR4);

        // SignalRegionData results_SR5;
        // results_SR5.sr_label = "SR5";
        // results_SR5.n_obs = 0.;
        // results_SR5.n_bkg = 2.5;
        // results_SR5.n_bkg_err = 0.9;
        // results_SR5.n_sig_MC_sys = 0.;
        // results_SR5.n_sig_MC = _numSR5;
        // add_result(results_SR5);

        // SignalRegionData results_SR6;
        // results_SR6.sr_label = "SR6";
        // results_SR6.n_obs = 82;
        // results_SR6.n_bkg = 82.;
        // results_SR6.n_bkg_err = 9.5;
        // results_SR6.n_sig_MC_sys = 0.;
        // results_SR6.n_sig_MC = _numSR6;
        // add_result(results_SR6);

        // SignalRegionData results_SR7;
        // results_SR7.sr_label = "SR7";
        // results_SR7.n_obs = 9.;
        // results_SR7.n_bkg = 7.6;
        // results_SR7.n_bkg_err = 2.8;
        // results_SR7.n_sig_MC_sys = 0.;
        // results_SR7.n_sig_MC = _numSR7;
        // add_result(results_SR7);

        // SignalRegionData results_SR8;
        // results_SR8.sr_label = "SR8";
        // results_SR8.n_obs = 5.;
        // results_SR8.n_bkg = 5.6;
        // results_SR8.n_bkg_err = 1.6;
        // results_SR8.n_sig_MC_sys = 0.;
        // results_SR8.n_sig_MC = _numSR8;
        // add_result(results_SR8);

        // SignalRegionData results_SR9;
        // results_SR9.sr_label = "SR9";
        // results_SR9.n_obs = 1.;
        // results_SR9.n_bkg = 1.3;
        // results_SR9.n_bkg_err = 0.4;
        // results_SR9.n_sig_MC_sys = 0.;
        // results_SR9.n_sig_MC = _numSR9;
