...
namespace Gambit {
 ...
 //          cutflowFile<<"\\end{tabular} \n} \n\\end{table}"<<endl;
        ...
        results_SR2_SF_loose.n_obs = 153.;
        results_SR2_SF_loose.n_bkg = 133.;
        results_SR2_SF_loose.n_bkg_err = 22.;
        results_SR2_SF_loose.n_sig_MC_sys = 0.;
        results_SR2_SF_loose.n_sig_MC = _numSR2_SF_loose;
        add_result(results_SR2_SF_loose);

        SignalRegionData results_SR2_SF_tight;
        results_SR2_SF_tight.sr_label = "SR2_SF_tight";
        results_SR2_SF_tight.n_obs = 9.;
        results_SR2_SF_tight.n_bkg = 9.8;
        results_SR2_SF_tight.n_bkg_err = 2.9;
        results_SR2_SF_tight.n_sig_MC_sys = 0.;
        results_SR2_SF_tight.n_sig_MC = _numSR2_SF_tight;
        add_result(results_SR2_SF_tight);

        SignalRegionData results_SR2_DF_100;
        results_SR2_DF_100.sr_label = "SR2_DF_100";
        results_SR2_DF_100.n_obs = 78.;
        results_SR2_DF_100.n_bkg = 68.;
        results_SR2_DF_100.n_bkg_err = 7.;
        results_SR2_DF_100.n_sig_MC_sys = 0.;
        results_SR2_DF_100.n_sig_MC = _numSR2_DF_100;
        add_result(results_SR2_DF_100);

        SignalRegionData results_SR2_DF_150;
        results_SR2_DF_150.sr_label = "SR2_DF_150";
        results_SR2_DF_150.n_obs = 11;
        results_SR2_DF_150.n_bkg = 11.5;
        results_SR2_DF_150.n_bkg_err = 3.1;
        results_SR2_DF_150.n_sig_MC_sys = 0.;
        results_SR2_DF_150.n_sig_MC = _numSR2_DF_150;
        add_result(results_SR2_DF_150);

        SignalRegionData results_SR2_DF_200;
        results_SR2_DF_200.sr_label = "SR2_DF_200";
        results_SR2_DF_200.n_obs = 6.;
        results_SR2_DF_200.n_bkg = 2.1;
        results_SR2_DF_200.n_bkg_err = 1.9;
        results_SR2_DF_200.n_sig_MC_sys = 0.;
        results_SR2_DF_200.n_sig_MC = _numSR2_DF_200;
        add_result(results_SR2_DF_200);

        SignalRegionData results_SR2_DF_300;
        results_SR2_DF_300.sr_label = "SR2_DF_300";
        results_SR2_DF_300.n_obs = 2.;
        results_SR2_DF_300.n_bkg = 0.6;
        results_SR2_DF_300.n_bkg_err = 0.6;
        results_SR2_DF_300.n_sig_MC_sys = 0.;
        results_SR2_DF_300.n_sig_MC = _numSR2_DF_300;
        add_result(results_SR2_DF_300);

        SignalRegionData results_SR2_int;
        results_SR2_int.sr_label = "SR2_int";
        results_SR2_int.n_obs = 2.;
        results_SR2_int.n_bkg = 4.1;
        results_SR2_int.n_bkg_err = 2.6;
        results_SR2_int.n_sig_MC_sys = 0.;
        results_SR2_int.n_sig_MC = _numSR2_int;
        add_result(results_SR2_int);

        SignalRegionData results_SR2_high;
        results_SR2_high.sr_label = "SR2_high";
        results_SR2_high.n_obs = 0.;
        results_SR2_high.n_bkg = 1.6;
        results_SR2_high.n_bkg_err = 1.6;
        results_SR2_high.n_sig_MC_sys = 0.;
        results_SR2_high.n_sig_MC = _numSR2_high;
        add_result(results_SR2_high);

        SignalRegionData results_SR2_low;
        results_SR2_low.sr_label = "SR2_low";
        results_SR2_low.n_obs = 11.;
        results_SR2_low.n_bkg = 4.2;
        results_SR2_low.n_bkg_err = 3.8;
        results_SR2_low.n_sig_MC_sys = 0.;
        results_SR2_low.n_sig_MC = _numSR2_low;
        add_result(results_SR2_low);

        SignalRegionData results_SR3_slep_a;
        results_SR3_slep_a.sr_label = "SR3_slep_a";
        results_SR3_slep_a.n_obs = 4.;
        results_SR3_slep_a.n_bkg = 2.23;
        results_SR3_slep_a.n_bkg_err = 0.79;
        results_SR3_slep_a.n_sig_MC_sys = 0.;
        results_SR3_slep_a.n_sig_MC = _numSR3_slep_a;
        add_result(results_SR3_slep_a);

        SignalRegionData results_SR3_slep_b;
        results_SR3_slep_b.sr_label = "SR3_slep_b";
        results_SR3_slep_b.n_obs = 3.;
        results_SR3_slep_b.n_bkg = 2.79;
        results_SR3_slep_b.n_bkg_err = 0.43;
        results_SR3_slep_b.n_sig_MC_sys = 0.;
        results_SR3_slep_b.n_sig_MC = _numSR3_slep_b;
        add_result(results_SR3_slep_b);

        SignalRegionData results_SR3_slep_c;
        results_SR3_slep_c.sr_label = "SR3_slep_c";
        results_SR3_slep_c.n_obs = 9.;
        results_SR3_slep_c.n_bkg = 5.41;
        results_SR3_slep_c.n_bkg_err = 0.93;
        results_SR3_slep_c.n_sig_MC_sys = 0.;
        results_SR3_slep_c.n_sig_MC = _numSR3_slep_c;
        add_result(results_SR3_slep_c);

        SignalRegionData results_SR3_slep_d;
        results_SR3_slep_d.sr_label = "SR3_slep_d";
        results_SR3_slep_d.n_obs = 0.;
        results_SR3_slep_d.n_bkg = 1.42;
        results_SR3_slep_d.n_bkg_err = 0.38;
        results_SR3_slep_d.n_sig_MC_sys = 0.;
        results_SR3_slep_d.n_sig_MC = _numSR3_slep_d;
        add_result(results_SR3_slep_d);

        SignalRegionData results_SR3_slep_e;
        results_SR3_slep_e.sr_label = "SR3_slep_e";
        results_SR3_slep_e.n_obs = 0.;
        results_SR3_slep_e.n_bkg = 1.14;
        results_SR3_slep_e.n_bkg_err = 0.23;
        results_SR3_slep_e.n_sig_MC_sys = 0.;
        results_SR3_slep_e.n_sig_MC = _numSR3_slep_e;
        add_result(results_SR3_slep_e);

        SignalRegionData results_SR3_WZ_0Ja;
        results_SR3_WZ_0Ja.sr_label = "SR3_WZ_0Ja";
        results_SR3_WZ_0Ja.n_obs = 21.;
        results_SR3_WZ_0Ja.n_bkg = 21.74;
        results_SR3_WZ_0Ja.n_bkg_err = 2.85;
        results_SR3_WZ_0Ja.n_sig_MC_sys = 0.;
        results_SR3_WZ_0Ja.n_sig_MC = _numSR3_WZ_0Ja;
        add_result(results_SR3_WZ_0Ja);

        SignalRegionData results_SR3_WZ_0Jb;
        results_SR3_WZ_0Jb.sr_label = "SR3_WZ_0Jb";
        results_SR3_WZ_0Jb.n_obs = 1.;
        results_SR3_WZ_0Jb.n_bkg = 2.68;
        results_SR3_WZ_0Jb.n_bkg_err = 0.46;
        results_SR3_WZ_0Jb.n_sig_MC_sys = 0.;
        results_SR3_WZ_0Jb.n_sig_MC = _numSR3_WZ_0Jb;
        add_result(results_SR3_WZ_0Jb);

        SignalRegionData results_SR3_WZ_0Jc;
        results_SR3_WZ_0Jc.sr_label = "SR3_WZ_0Jc";
        results_SR3_WZ_0Jc.n_obs = 2.;
        results_SR3_WZ_0Jc.n_bkg = 1.56;
        results_SR3_WZ_0Jc.n_bkg_err = 0.33;
        results_SR3_WZ_0Jc.n_sig_MC_sys = 0.;
        results_SR3_WZ_0Jc.n_sig_MC = _numSR3_WZ_0Jc;
        add_result(results_SR3_WZ_0Jc);

        SignalRegionData results_SR3_WZ_1Ja;
        results_SR3_WZ_1Ja.sr_label = "SR3_WZ_1Ja";
        results_SR3_WZ_1Ja.n_obs = 1.;
        results_SR3_WZ_1Ja.n_bkg = 2.21;
        results_SR3_WZ_1Ja.n_bkg_err = 0.53;
        results_SR3_WZ_1Ja.n_sig_MC_sys = 0.;
        results_SR3_WZ_1Ja.n_sig_MC = _numSR3_WZ_1Ja;
        add_result(results_SR3_WZ_1Ja);

        SignalRegionData results_SR3_WZ_1Jb;
        results_SR3_WZ_1Jb.sr_label = "SR3_WZ_1Jb";
        results_SR3_WZ_1Jb.n_obs = 3.;
        results_SR3_WZ_1Jb.n_bkg = 1.82;
        results_SR3_WZ_1Jb.n_bkg_err = 0.26;
        results_SR3_WZ_1Jb.n_sig_MC_sys = 0.;
        results_SR3_WZ_1Jb.n_sig_MC = _numSR3_WZ_1Jb;
        add_result(results_SR3_WZ_1Jb);

        SignalRegionData results_SR3_WZ_1Jc;
        results_SR3_WZ_1Jc.sr_label = "SR3_WZ_1Jc";
        results_SR3_WZ_1Jc.n_obs = 4.;
        results_SR3_WZ_1Jc.n_bkg = 1.26;
        results_SR3_WZ_1Jc.n_bkg_err = 0.34;
        results_SR3_WZ_1Jc.n_sig_MC_sys = 0.;
        results_SR3_WZ_1Jc.n_sig_MC = _numSR3_WZ_1Jc;
