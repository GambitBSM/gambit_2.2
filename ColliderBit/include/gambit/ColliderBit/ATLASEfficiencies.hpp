    ...
    namespace ATLAS
    {
      ...
      ///@{
        ...
        inline void applyElectronIDEfficiency2019(std::vector<HEPUtils::Particle*>& electrons, str operating_point)
        {
          ...
          const static std::vector<double> binedges_pt    = { 5.774058577405857, 8.493723849372387, 12.468619246861927, 17.489539748953973, 22.510460251046027, 27.322175732217566, 32.55230125523013, 37.364016736401666, 42.38493723849373, 47.405857740585766, 54.93723849372385, 70, 114.76987447698744};
        ...
        inline void applyElectronIsolationEfficiency2019(std::vector<HEPUtils::Particle*>& electrons, str operating_point)
        {
          ...
          const static std::vector<double> binedges_pt = {5.564853556485357, 8.702928870292887, 12.677824267782427, 17.489539748953973, 22.510460251046027, 27.531380753138073, 32.55230125523013, 37.57322175732217, 42.594142259414234, 47.61506276150627, 54.93723849372385, 70, 114.97907949790795};
