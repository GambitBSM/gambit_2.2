...
// File generated at Wed 23 Oct 2019 19:00:57
...
void put_spectrum(const CMSSM_slha<Model>& model, MLINK link)
{
   ...
   MLPutRuleTo(link, MODELPARAMETER(MVG), "VG", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MGlu), "Glu", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MFv), "Fv", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MSd), "Sd", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MSv), "Sv", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MSu), "Su", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MSe), "Se", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(Mhh), "hh", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MAh), "Ah", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MHpm), "Hpm", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MChi), "Chi", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MCha), "Cha", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MFe), "Fe", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MFd), "Fd", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MFu), "Fu", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MVWm), "VWm", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MVP), "VP", {"FlexibleSUSY`M"});
   MLPutRuleTo(link, MODELPARAMETER(MVZ), "VZ", {"FlexibleSUSY`M"});
   ...
   MLPutRuleTo(link, MODELPARAMETER(ZZ), "ZZ");
   MLPutRuleTo(link, PHYSICALPARAMETER(MVG), "VG", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MGlu), "Glu", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MFv), "Fv", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MSd), "Sd", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MSv), "Sv", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MSu), "Su", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MSe), "Se", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(Mhh), "hh", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MAh), "Ah", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MHpm), "Hpm", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MChi), "Chi", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MCha), "Cha", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MFe), "Fe", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MFd), "Fd", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MFu), "Fu", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MVWm), "VWm", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MVP), "VP", {"Pole", "FlexibleSUSY`M"});
   MLPutRuleTo(link, PHYSICALPARAMETER(MVZ), "VZ", {"Pole", "FlexibleSUSY`M"});
