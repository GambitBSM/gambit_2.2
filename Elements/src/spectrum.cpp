...
namespace Gambit
{
   ...
   Spectrum::Spectrum(const SubSpectrum& le, const SubSpectrum& he, const SMInputs& smi, const params* pars,
   ...
   Spectrum::Spectrum(const SubSpectrum& he, const SMInputs& smi, const params* pars, const mc_info& mci, const mr_info& mri)
   ...
   Spectrum::Spectrum(SubSpectrum* const le, SubSpectrum* const he, const SMInputs& smi, const params* pars,
    const mc_info& mci, const mr_info& mri)
     : LE(le)
     , HE(he)
     , SMINPUTS(smi)
