...
#include "flexiblesusy/models/CMSSM_spectrum_generator.hpp"
#include "flexiblesusy/models/CMSSM_slha_io.hpp"
#include "flexiblesusy/models/CMSSM_two_scale_spectrum_generator.hpp"
