...
echo "diff -rupN FlexibleSUSY-2.4.0/models/CMSSM/CMSSM_model_slha.hpp ../installed/flexiblesusy/2.4.0/CMSSM/models/CMSSM/CMSSM_model_slha.hpp" >> patch_flexiblesusy_2.4.0_CMSSM.dif
diff -rupN FlexibleSUSY-2.4.0/models/CMSSM/CMSSM_model_slha.hpp ../installed/flexiblesusy/2.4.0/CMSSM/models/CMSSM/CMSSM_model_slha.hpp >> patch_flexiblesusy_2.4.0_CMSSM.dif
