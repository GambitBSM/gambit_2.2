...
BE_CONV_FUNCTION(BKstarmumu, Flav_KstarMuMu_obs, (const parameters*, double, double), "BKstarmumu", (MSSM63atQ, MSSM63atMGUT, WC))
...
BE_CONV_FUNCTION(A_BXsmumu_highq2, double, (const parameters*), "A_BXsmumu_highq2",(MSSM63atQ, MSSM63atMGUT, WC))
