...
mpiexec -outfile-pattern=runs/DMEFT_all_WCs_diver_varying_lambda/DMEFT_all_WCs_diver_varying_lambda.out-%r -errfile-pattern=runs/DMEFT_all_WCs_diver_varying_lambda/DMEFT_all_WCs_diver_varying_lambda.err-%r ./gambit -f DMEFT_scans/yaml_files/DMEFT_all_WCs_diver_varying_lambda.yaml