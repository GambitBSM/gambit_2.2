...
#SBATCH -o runs/DMEFT_all_WCs_diver_varying_lambda/DMEFT_all_WCs_diver_varying_lambda.out      # File to which STDOUT will be written
#SBATCH -e runs/DMEFT_all_WCs_diver_varying_lambda/DMEFT_all_WCs_diver_varying_lambda.err      # File to which STDERR will be written
...
mpiexec -outfile-pattern=runs/DMEFT_all_WCs_diver_varying_lambda/DMEFT_all_WCs_diver_varying_lambda.out-%r -errfile-pattern=runs/DMEFT_all_WCs_diver_varying_lambda/DMEFT_all_WCs_diver_varying_lambda.err-%r ./gambit -rf DMEFT_scans/yaml_files/DMEFT_all_WCs_diver_varying_lambda.yaml