...
#SBATCH -o runs/DMEFT_C64_diver_500GeV/DMEFT_C64_diver_500GeV.out      # File to which STDOUT will be written
#SBATCH -e runs/DMEFT_C64_diver_500GeV/DMEFT_C64_diver_500GeV.err      # File to which STDERR will be written
...
mpiexec -outfile-pattern=runs/DMEFT_C64_diver_500GeV/DMEFT_C64_diver_500GeV.out-%r -errfile-pattern=runs/DMEFT_C64_diver_500GeV/DMEFT_C64_diver_500GeV.err-%r ./gambit -rf DMEFT_scans/yaml_files/500GeV/DMEFT_C64_diver_500GeV.yaml