...
#SBATCH -o runs/DMEFT_C710_diver_100GeV/DMEFT_C710_diver_100GeV.out      # File to which STDOUT will be written
#SBATCH -e runs/DMEFT_C710_diver_100GeV/DMEFT_C710_diver_100GeV.err      # File to which STDERR will be written
...
mpiexec -outfile-pattern=runs/DMEFT_C710_diver_100GeV/DMEFT_C710_diver_100GeV.out-%r -errfile-pattern=runs/DMEFT_C710_diver_100GeV/DMEFT_C710_diver_100GeV.err-%r ./gambit -rf DMEFT_scans/yaml_files/100GeV/DMEFT_C710_diver_100GeV.yaml