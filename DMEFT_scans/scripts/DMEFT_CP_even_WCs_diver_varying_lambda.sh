...
mpiexec -outfile-pattern=runs/DMEFT_CP_even_WCs_diver_varying_lambda/DMEFT_CP_even_WCs_diver_varying_lambda.out-%r -errfile-pattern=runs/DMEFT_CP_even_WCs_diver_varying_lambda/DMEFT_CP_even_WCs_diver_varying_lambda.err-%r ./gambit -f DMEFT_scans/yaml_files/DMEFT_CP_even_WCs_diver_varying_lambda.yaml