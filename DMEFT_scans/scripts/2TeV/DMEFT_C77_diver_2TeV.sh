...
#SBATCH -o runs/DMEFT_C77_diver_2TeV/DMEFT_C77_diver_2TeV.out      # File to which STDOUT will be written
#SBATCH -e runs/DMEFT_C77_diver_2TeV/DMEFT_C77_diver_2TeV.err      # File to which STDERR will be written
...
mpiexec -outfile-pattern=runs/DMEFT_C77_diver_2TeV/DMEFT_C77_diver_2TeV.out-%r -errfile-pattern=runs/DMEFT_C77_diver_2TeV/DMEFT_C77_diver_2TeV.err-%r ./gambit -rf DMEFT_scans/yaml_files/2TeV/DMEFT_C77_diver_2TeV.yaml