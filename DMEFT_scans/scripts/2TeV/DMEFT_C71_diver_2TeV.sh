...
mpiexec -outfile-pattern=runs/DMEFT_C71_diver_2TeV/DMEFT_C71_diver_2TeV.out-%r -errfile-pattern=runs/DMEFT_C71_diver_2TeV/DMEFT_C71_diver_2TeV.err-%r ./gambit -f DMEFT_scans/yaml_files/2TeV/DMEFT_C71_diver_2TeV.yaml