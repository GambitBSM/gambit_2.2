...
#SBATCH -o runs/DMEFT_C76_diver_2TeV/DMEFT_C76_diver_2TeV.out      # File to which STDOUT will be written
#SBATCH -e runs/DMEFT_C76_diver_2TeV/DMEFT_C76_diver_2TeV.err      # File to which STDERR will be written
