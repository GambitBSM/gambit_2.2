...
macro(BOSS_backend_full name backend_version include_ROOT)
  ...
  if(NOT EXISTS ${config_file_path})
    ...
    if(${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
      set(dl "https://data.kitware.com/api/v1/file/5e8b73f72660cbefba944110/download")
      set(dl_filename "castxml-macosx.tar.gz")
    else()
      set(dl "https://data.kitware.com/api/v1/file/5e8b740d2660cbefba944189/download")
    ...
    ExternalProject_Add_Step(${name}_${ver} BOSS
      ...
      # Run BOSS
      COMMAND ${PYTHON_EXECUTABLE} ${BOSS_dir}/boss.py ${BOSS_castxml_cc} ${BOSS_includes_Boost} ${BOSS_includes_Eigen3} ${BOSS_includes_GSL} ${include_ROOT} ${name}_${backend_version_safe}
